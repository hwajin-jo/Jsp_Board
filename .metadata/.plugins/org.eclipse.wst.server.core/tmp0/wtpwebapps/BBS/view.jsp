	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<% if (boardID == 1){ %>
					<li class="active"><a href="bbs.jsp?boardID=1&pageNumber=1">영화 소개</a></li>
	...
	<div class="container">
		...
		<div class="container">
			<table class="table table-haver" style="border: 1px solid #dddddd">
					...
					%>
					<tr align="center">
						<td colspan="3"><button onclick="location.href='evaluationAction.jsp?likeit=1&badit=0&bbsID=<%=bbsID%>'">좋아요(<%=like %>)</button></td>			
						<td colspan="3"><button onclick="location.href='evaluationAction.jsp?likeit=0&badit=1&bbsID=<%=bbsID%>'">싫어요(<%=bad %>)</button></td>		
					</tr>
					<tr>
					<%
						}
